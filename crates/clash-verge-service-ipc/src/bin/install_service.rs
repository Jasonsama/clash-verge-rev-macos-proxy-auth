...
fn main() -> Result<(), Error> {
    ...
    // 定义 bundle 路径
    let bundle_path = "/Library/PrivilegedHelperTools/io.github.clash-verge-rev.clash-verge-rev.service.bundle";
    ...
    // 创建并写入 launchd plist
    let plist_file = "/Library/LaunchDaemons/io.github.clash-verge-rev.clash-verge-rev.service.plist";
    ...
    let _ = run_command(
        "launchctl",
        &["enable", "system/io.github.clash-verge-rev.clash-verge-rev.service"],
        debug,
    );
